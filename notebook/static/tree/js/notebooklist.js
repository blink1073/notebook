...
define([
    ...
    NotebookList.prototype.handleFilesUpload =  function(event, dropOrForm) {
        ...
        for (var i = 0; i < files.length; i++) {
            ...
            // CHANGE_FLAG: replace the error message to the new upload function
    ...
    // CHANGE_FLAG: add a new class for large file upload
        ...
        var upload_button = $('<button/>').text("Upload")
            ...
            .click(function (e) {
                ...
                var add_uploading_button = function (f, item) {
                    ...
                    var uploading_button = item.find('.upload_button')
                        .text("Uploading");
                        // .addClass('disabled');
